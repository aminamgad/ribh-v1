  ...
  const onSubmit = async (data: any) => {
    ...
    try {
      ...
      if (data.role === 'admin' && data.isStaff) {
        (normalizedData as any).isStaff = true;
        (normalizedData as any).staffRole = data.staffRole === 'custom' ? 'custom' : 'full_admin';
        (normalizedData as any).permissions = data.staffRole === 'custom' ? customPermissions : undefined;
      } else if (data.role === 'admin') {
        (normalizedData as any).isStaff = false;
        (normalizedData as any).staffRole = undefined;
        (normalizedData as any).permissions = undefined;
      }
            ...
            <div className="bg-white dark:bg-slate-800 rounded-lg p-6 border border-gray-200 dark:border-slate-700">
              ...
              <div className="space-y-4">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-gray-700 dark:text-slate-300">موظف إدارة (صلاحيات محددة أو كاملة)</span>
                </label>
                {watchedValues.isStaff && (
                  <>
                    ...
                    {watchedValues.staffRole === 'custom' && (
                      <div className="mt-4">
                        <p className="text-sm font-medium text-gray-700 dark:text-slate-300 mb-3">حدد الصلاحيات:</p>
                        <PermissionSelector
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  {errors.commercialRegisterNumber && (
                    <p className="text-red-500 text-sm mt-1">{errors.commercialRegisterNumber.message}</p>
                  )}
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  {errors.wholesaleLicense && (
                    <p className="text-red-500 text-sm mt-1">{errors.wholesaleLicense.message}</p>
                  )}
                </div>
