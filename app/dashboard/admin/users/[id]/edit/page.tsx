    ...
    <div className="min-h-screen bg-gray-50 dark:bg-slate-900">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          {/* صلاحيات الموظف - عند دور الإدارة */}
          {(watchedValues.role as string) === 'admin' && (
            <div className="bg-white dark:bg-slate-800 rounded-lg p-6 border border-gray-200 dark:border-slate-700">
              ...
              <p className="text-sm text-gray-500 dark:text-slate-400 mb-6">صلاحيات كاملة أو مخصصة لهذا الحساب.</p>
                ...
                {watchedValues.isStaff && (
                  <>
                    <div className="p-1 rounded-xl bg-gray-100 dark:bg-slate-700/60 inline-flex gap-0.5 border border-gray-200/80 dark:border-slate-600">
                      ...
                      <input
                        type="radio"
                        id="staffRole-custom-edit"
                        value="custom"
                        {...register('staffRole')}
                        className="sr-only"
                      />
                      <label
                        htmlFor="staffRole-full_admin-edit"
