...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-secondary-50 dark:from-gray-900 dark:to-gray-800">
      ...
      {/* Features Section */}
      <section id="features" className="py-20 bg-gray-100 dark:bg-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 dark:text-slate-100 mb-4">
              لماذا تختار منصة ربح؟
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-slate-100 mb-2">أدوار متعددة</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-slate-100 mb-2">عمولات ذكية</h3>
              <p className="text-gray-700 dark:text-slate-300">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-slate-100 mb-2">حماية متكاملة</h3>
              <p className="text-gray-700 dark:text-slate-300">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 dark:text-slate-100 mb-2">توصيل موثوق</h3>
              <p className="text-gray-700 dark:text-slate-300">
      ...
      <section className="py-20 bg-white dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {/* Supplier */}
            <div className="bg-gray-50 dark:bg-slate-800 rounded-lg p-6 shadow-soft dark:shadow-soft-dark">
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-slate-100 mb-2">المورد</h3>
                <p className="text-gray-700 dark:text-slate-300">رفع المنتجات وإدارة المخزون</p>
              </div>
              <ul className="space-y-3 text-right">
                <li className="flex items-center">
                  <Star className="w-5 h-5 text-primary-500 dark:text-primary-400 ml-2" />
                  <span className="text-gray-700 dark:text-slate-200">رفع المنتجات للمنصة</span>
                </li>
                <li className="flex items-center">
                  <Star className="w-5 h-5 text-primary-500 dark:text-primary-400 ml-2" />
                  <span className="text-gray-700 dark:text-slate-200">إدارة المخزون والأسعار</span>
                </li>
                <li className="flex items-center">
                  <Star className="w-5 h-5 text-primary-500 dark:text-primary-400 ml-2" />
                  <span className="text-gray-700 dark:text-slate-200">متابعة الطلبات والتوصيل</span>
                </li>
                <li className="flex items-center">
                  <Star className="w-5 h-5 text-primary-500 dark:text-primary-400 ml-2" />
                  <span className="text-gray-700 dark:text-slate-200">ربح من المبيعات</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-slate-800 rounded-lg p-6 shadow-soft dark:shadow-soft-dark">
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-slate-100 mb-2">المسوق</h3>
                <p className="text-gray-700 dark:text-slate-300">تسويق المنتجات للعملاء</p>
              </div>
              <ul className="space-y-3 text-right">
                <li className="flex items-center">
                  <Star className="w-5 h-5 text-success-500 dark:text-success-400 ml-2" />
                  <span className="text-gray-700 dark:text-slate-200">تصفح المنتجات المعتمدة</span>
                </li>
                <li className="flex items-center">
                  <Star className="w-5 h-5 text-success-500 dark:text-success-400 ml-2" />
                  <span className="text-gray-700 dark:text-slate-200">طلب المنتجات للعملاء</span>
                </li>
                <li className="flex items-center">
                  <Star className="w-5 h-5 text-success-500 dark:text-success-400 ml-2" />
                  <span className="text-gray-700 dark:text-slate-200">متابعة الطلبات والتوصيل</span>
                ...
                <li className="flex items-center">
                  <Star className="w-5 h-5 text-success-500 dark:text-success-400 ml-2" />
                  <span className="text-gray-700 dark:text-slate-200">ربح من العمولات</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-gray-50 dark:bg-slate-800 rounded-lg p-6 shadow-soft dark:shadow-soft-dark">
              <div className="text-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-gray-900 dark:text-slate-100 mb-2">تاجر الجملة</h3>
                <p className="text-gray-700 dark:text-slate-300">شراء بأسعار الجملة وإعادة البيع</p>
              </div>
              <ul className="space-y-3 text-right">
                <li className="flex items-center">
                  <Star className="w-5 h-5 text-warning-500 dark:text-warning-400 ml-2" />
                  <span className="text-gray-700 dark:text-slate-200">أسعار جملة خاصة</span>
                </li>
                <li className="flex items-center">
                  <Star className="w-5 h-5 text-warning-500 dark:text-warning-400 ml-2" />
                  <span className="text-gray-700 dark:text-slate-200">شراء كميات كبيرة</span>
                </li>
                <li className="flex items-center">
                  <Star className="w-5 h-5 text-warning-500 dark:text-warning-400 ml-2" />
                  <span className="text-gray-700 dark:text-slate-200">إعادة البيع مباشرة</span>
                </li>
                <li className="flex items-center">
                  <Star className="w-5 h-5 text-warning-500 dark:text-warning-400 ml-2" />
                  <span className="text-gray-700 dark:text-slate-200">أرباح أعلى من المسوقين</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-300 dark:text-gray-400">
                منصة التجارة الإلكترونية الذكية التي تربط الموردين والمسوقين وتجار الجملة
              </p>
            </div>
            <div>
