          ...
          <div className="bg-gray-50 dark:bg-slate-900/50 rounded-lg p-4 mb-4 border border-gray-200 dark:border-slate-700">
            ...
            <div className="space-y-3">
              ...
              {draftData.images && draftData.images.length > 0 && (
                <div className="flex items-start gap-2">
                  <ImageIcon className="w-4 h-4 text-[#FF9800] mt-0.5 flex-shrink-0" />
              ...
              {draftData.currentStep && (
                <div className="flex items-start gap-2">
                  <FileText className="w-4 h-4 text-[#FF9800] mt-0.5 flex-shrink-0" />
                  <div className="flex-1">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex flex-wrap gap-1 mt-1">
                      {draftData.tags.slice(0, 3).map((tag, idx) => (
                        <span key={idx} className="text-xs px-2 py-0.5 bg-[#FF9800]/20 dark:bg-[#FF9800]/30 text-[#E65100] dark:text-[#FFB74D] rounded-full">
                          {tag}
                        </span>
                      ))}
            ...
            <div className="flex items-center gap-3 text-sm">
              ...
              <div className="flex-1">
                <div className="w-full bg-gray-200 dark:bg-slate-700 rounded-full h-2">
                  <div 
                    className="bg-gradient-to-r from-[#FF9800] to-[#F57C00] h-2 rounded-full transition-all duration-500"
          ...
          <div className="mt-4 pt-4 border-t border-gray-200 dark:border-slate-700">
            <label className="flex items-center gap-2 cursor-pointer group">
              <input
                ...
                className="w-4 h-4 text-[#FF9800] bg-gray-100 border-gray-300 rounded focus:ring-[#FF9800] dark:focus:ring-[#FFB74D] dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
              />
