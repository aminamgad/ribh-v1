...
export const countries: Country[] = [
  ...
  { code: 'CG', nameAr: 'جمهورية الكونغو', nameEn: 'Congo' },
  ...
  { code: 'CD', nameAr: 'جمهورية الكونغو الديمقراطية', nameEn: 'Democratic Republic of the Congo' },
  ...
  { code: 'ST', nameAr: 'ساو تومي وبرينسيبي', nameEn: 'Sao Tome and Principe' },
...
export const getCountryByName = (name: string): Country | undefined => {
  return countries.find(country => 
    country.nameAr === name || country.nameEn === name
  );
};
